...
let broker = {
  ...
  //  hostname: 'broker.shiftr.io ', + url of project
  hostname: 'broker.shiftr.io/rios/arduinosendreceivetest',
...
let creds = {
  ...
  userName: '598e8aa4', // unique Key from token
  password: '9f3cf26de89e20dd' // unique Secret from token
}
